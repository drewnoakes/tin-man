...
public string TeamName;
    ...
    private List<HingeJointState> HingeJointStates;
...
out id, out side);
				GameTime = t; PlayMode = pm; PlayerId = id; TeamSide = side; 
				break;
			}
			case 31: {
				double t, b; 
			...
			case 21: {
				if (HingeJointStates==null) HingeJointStates = new List<HingeJointState>(1); HingeJointState hjState; 
				HingeJointExpr(out hjState);
				HingeJointStates.Add(hjState); 
				break;
			}
			case 23: {
		...
		State = new PerceptorState(
		                     ...
		                     GyroStates, HingeJointStates, UniversalJointStates,
